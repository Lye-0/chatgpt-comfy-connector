...
public static class CreationPipelineStateMachine
{
    ...
    public static void PrepareContext(CreationSession session, string detail = "Workflow / Project / Chatを設定してください")
    {
        EnsureInitialized(session);
        ...
        Set(session, CreationStage.Context, CreationStageState.Current, detail);
