...
public partial class MainWindow : Window
{
    ...
    private async void Validate_Click(object sender, RoutedEventArgs e) => await Run("Workflow validate", ViewModel.ValidateCurrentAsync);
    private async void Generate_Click(object sender, RoutedEventArgs e) => await Run("生成", () => ViewModel.GenerateAsync());
    private async void CancelJob_Click(object sender, RoutedEventArgs e) => await Run("Job cancel", ViewModel.CancelJobAsync);
    ...
    private async void Resume_Click(object sender, RoutedEventArgs e) => await Run("Session再開", ViewModel.ResumeSessionAsync);
    private async void ImportCommand_Click(object sender, RoutedEventArgs e) => await Run("Command検証", ViewModel.ImportCommandAsync);
    private async void ApplyCommand_Click(object sender, RoutedEventArgs e) => await Run("Command適用", () => ViewModel.ApplyCommandAsync(false));
    private async void ApplyGenerateCommand_Click(object sender, RoutedEventArgs e) => await Run("Command適用 + 生成", () => ViewModel.ApplyCommandAsync(true));
